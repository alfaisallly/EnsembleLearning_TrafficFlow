classdef SimDataProvider < DataProvider
    ...
    methods
        ...
        function [this] = SimDataProvider(mr,end_time)
                    
            % collect data
            link_ids = mr.get_link_ids;
            link_lengths = mr.network_information.get_lengths_for_linkids_in_km(link_ids);

            % super constructor
            this = this@DataProvider(nan,link_ids,link_ids,link_lengths,mr.out_dt,'');
